...
DEFAULT_DATA_PATH = "/test/etc/plab"
...
PLABNODE = "/test/sbin/plabnode"
SSH = "/test/bin/sshtb"
NAMED_SETUP = "/test/sbin/named_setup"
PELAB_PUSH  = "/test/sbin/pelab_opspush"

ROOTBALL_URL = "http://localhost:1492/" # ensure this ends in a slash

DEF_SITE_XML = "/xml/sites.xml"
IGNORED_NODES_FILE = "/test/etc/plab/IGNOREDNODES"
ALLOWED_NODES_FILE = "/test/etc/plab/ALLOWEDNODES"
