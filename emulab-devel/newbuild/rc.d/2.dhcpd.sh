...
case "$1" in
	start|faststart|quietstart|onestart|forcestart)
		...
		cnetif=
		if [ $elabinelab != "1" -a -x /home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild/sbin/findif ]; then
		    cnetif=`/home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild/sbin/findif -i 198.22.255.3`
		fi
