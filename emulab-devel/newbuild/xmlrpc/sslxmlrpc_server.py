...
TBPATH = "/home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild/lib"
...
server_cert     = "/home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild/etc/server.pem"
ca_cert         = "/home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild/etc/emulab.pem"
...
#
ALLOWED_PATHS  = [ STD_PATH, "/home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild" ]
...
if not debug:
    ...
    if not foreground:
        ...
        #
        try:
            fp = open("/home/achauhan06/CLOUDLAB/SSHCLOUD/CloudLabonESI/emulab-devel/newbuild/log/sslxmlrpc_server.log", "a");
            sys.stdout = fp
            sys.stderr = fp
            sys.stdin.close();
            pass
