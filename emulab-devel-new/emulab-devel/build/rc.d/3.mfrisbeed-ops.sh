...
if [ "$DEBUG" != "true" -a -x /users/mshobana/emulab-devel/build/sbin/daemon_wrapper ]; then
    /users/mshobana/emulab-devel/build/sbin/daemon_wrapper -i 30 -l /users/mshobana/emulab-devel/build/log/mfrisbeed_wrapper.log \
	/users/mshobana/emulab-devel/build/sbin/mfrisbeed -d $args $opts
else
    /users/mshobana/emulab-devel/build/sbin/mfrisbeed $args $opts
fi
