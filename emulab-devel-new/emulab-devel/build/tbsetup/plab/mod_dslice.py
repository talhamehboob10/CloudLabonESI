...
sys.path.append("/users/mshobana/emulab-devel/build/lib/dslice")
sys.path.append("/users/mshobana/emulab-devel/build/lib/dslice/dslice")
sys.path.append("/users/mshobana/emulab-devel/build/lib/dslice/HTMLgen")
