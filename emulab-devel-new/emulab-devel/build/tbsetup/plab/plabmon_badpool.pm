...
my $SSH = "/users/mshobana/emulab-devel/build/bin/sshtb -n";
my $PLABNODE = "/users/mshobana/emulab-devel/build/sbin/plabnode";
my $PLABDIST = "/users/mshobana/emulab-devel/build/sbin/plabdist";
my $PLABHTTPD = "/users/mshobana/emulab-devel/build/sbin/plabhttpd";
# XXX - testing
