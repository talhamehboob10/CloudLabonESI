...
TBPATH = "/users/mshobana/emulab-devel/build/lib"
...
server_cert     = "/users/mshobana/emulab-devel/build/etc/server.pem"
ca_cert         = "/users/mshobana/emulab-devel/build/etc/emulab.pem"
...
#
ALLOWED_PATHS  = [ STD_PATH, "/users/mshobana/emulab-devel/build" ]
...
if not debug:
    ...
    if not foreground:
        ...
        #
        try:
            fp = open("/users/mshobana/emulab-devel/build/log/sslxmlrpc_server.log", "a");
            sys.stdout = fp
            sys.stderr = fp
            sys.stdin.close();
            pass
