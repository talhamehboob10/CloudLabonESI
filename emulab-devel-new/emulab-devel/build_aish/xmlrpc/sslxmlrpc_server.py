...
TBDIR = "/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish"
TBPATH = "/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/lib"
...
server_cert     = "/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/etc/server.pem"
ca_cert         = "/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/etc/emulab.pem"
...
#
ALLOWED_PATHS  = [ STD_PATH, "/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish" ]
...
if not debug:
    ...
    if not foreground:
        ...
        #
        try:
            fp = open("/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/log/sslxmlrpc_server.log", "a");
            sys.stdout = fp
            sys.stderr = fp
            sys.stdin.close();
            pass
