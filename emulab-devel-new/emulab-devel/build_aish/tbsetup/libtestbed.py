...
# Constants
#
TBOPS             = "testbed-ops\@ops.cloudlab.umass.edu".replace("\\","")
MAILTAG           = "UMASS"
SCRIPTNAME        = sys.argv[0][sys.argv[0].rfind("/")+1:]
DEFAULT_DATA_PATH = "/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/etc/plab/" # ensure this ends in a slash
