...
if [ -z "$DEBUG" -a -x /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/daemon_wrapper ]; then
	...
	/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/mfrisbeed -d $args
else
    /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/mfrisbeed $args
fi
