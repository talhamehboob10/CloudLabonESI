...
case "$1" in
	start|faststart|quietstart|onestart|forcestart)
		...
		cnetif=
		if [ $elabinelab != "1" -a -x /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/findif ]; then
		    cnetif=`/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/findif -i 198.22.255.3`
		fi
