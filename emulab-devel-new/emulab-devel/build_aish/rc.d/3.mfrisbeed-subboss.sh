...
bindir=/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin
...
if [ "$DEBUG" != "true" -a -x /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/daemon_wrapper ]; then
    /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/daemon_wrapper -i 30 -l /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/log/mfrisbeed_wrapper.log \
	/users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/mfrisbeed -d $args $opts
else
    /users/achauhan/Cloudlab/CloudLabonESI/emulab-devel-new/emulab-devel/build_aish/sbin/mfrisbeed $args $opts
fi
