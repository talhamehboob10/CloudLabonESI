...
#for oml end
	...
	uplevel 1 real_source "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/lib/ns2ir/${nsfilename}"
    }
    if {$security_level || $explicit_firewall} {
	uplevel 1 real_source "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/lib/ns2ir/fw.ns"
    }
