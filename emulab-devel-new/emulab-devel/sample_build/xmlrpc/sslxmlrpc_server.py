...
TBDIR = "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build"
TBPATH = "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/lib"
...
server_cert     = "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/etc/server.pem"
ca_cert         = "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/etc/emulab.pem"
...
#
ALLOWED_PATHS  = [ STD_PATH, "/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build" ]
...
if not debug:
    ...
    if not foreground:
        ...
        #
        try:
            fp = open("/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/log/sslxmlrpc_server.log", "a");
            sys.stdout = fp
            sys.stderr = fp
            sys.stdin.close();
            pass
