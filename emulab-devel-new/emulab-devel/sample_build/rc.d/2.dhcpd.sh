...
case "$1" in
	start|faststart|quietstart|onestart|forcestart)
		...
		cnetif=
		if [ $elabinelab != "1" -a -x /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/findif ]; then
		    cnetif=`/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/findif -i 198.22.255.3`
		fi
