...
if [ -z "$DEBUG" -a -x /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/daemon_wrapper ]; then
	...
	/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/mfrisbeed -d $args
else
    /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/mfrisbeed $args
fi
