...
ETCDIR="/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/etc"
LOGDIR="/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/log/pelab"
