...
bindir=/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin
...
if [ "$DEBUG" != "true" -a -x /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/daemon_wrapper ]; then
    /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/daemon_wrapper -i 30 -l /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/log/mfrisbeed_wrapper.log \
	/users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/mfrisbeed -d $args $opts
else
    /users/mshobana/CloudLabonESI/emulab-devel-new/emulab-devel/sample_build/sbin/mfrisbeed $args $opts
fi
